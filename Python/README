...
[Semantria](https://semantria.com) offers **Python SDK**, that is the most convenient way to get started with the Semantria API on Python.
SDK implements all the available Semantria features and demonstrate best practices of API usage for either Python 2.x or 3.x.
